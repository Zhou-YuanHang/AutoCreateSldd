classdef AutoCreateSlddGuiPrototypeApp < handle
    %
    % Usage:
    %     app.AutoCreateSlddGuiPrototypeApp
    ...
    properties (Constant)
        AppPathBase = {'/AutoCreateSlddGuiPrototype'};
        AppClass = 'AutoCreateSlddGuiPrototypeApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = AutoCreateSlddGuiPrototypeApp()
        ...
        function startApp(obj)
            ...
            mlock;
            AutoCreateSlddGuiPrototypeApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'AutoCreateSlddGuiPrototype')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong AutoCreateSlddGuiPrototype
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'AutoCreateSlddGuiPrototype').getString, ...
            ...
            if nargout(@AutoCreateSlddGuiPrototype) == 0
                eval('AutoCreateSlddGuiPrototype');
            else
                obj.AppHandle = eval('AutoCreateSlddGuiPrototype');
            end
