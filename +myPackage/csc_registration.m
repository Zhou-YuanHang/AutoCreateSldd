...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Generated on:   03-Dec-2025 17:53:44
...
switch action
  ...
  case 'CSCDefn'
    ...
    h = Simulink.CSCDefn;
    set(h, 'Name', 'YS_SelectRAMSignal');
    set(h, 'OwnerPackage', 'myPackage');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'YS_RAMSignal');
    ...
    h = Simulink.CSCDefn;
    set(h, 'Name', 'YS_SelectRAMPara');
    set(h, 'OwnerPackage', 'myPackage');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'YS_RAMPara');
    set(h, 'IsMemorySectionInstanceSpecific', false);
    set(h, 'IsGrouped', false);
        set(h.DataUsage, 'IsParameter', true);
  ...
  case 'MemorySectionDefn'
    ...
    set(h, 'Name', 'YS_RAMSignal');
    set(h, 'OwnerPackage', 'myPackage');
    set(h, 'Comment', '');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '// #pragram section "mcu_signal" 7200 257');
    set(h, 'PostPragma', '// #pragram section');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
    set(h, 'IsConst', false);
